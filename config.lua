...
maxPlayers = 0
motd = "Bem vindo ao Divine-Global!"
onePlayerOnlinePerAccount = true
allowClones = false
serverName = "Divine-Global"
...
ownerName = "divine-Global"
ownerEmail = "divineot@outlook.com"
url = "https://divine-global.online"
location = "South America"

-- Sends Discord webhook notifications on startup, raids and shutdown.
-- The URL layout is https://discord.com/api/webhooks/:id/:token
-- Leave empty if you wish to disable.
discordWebhookURL = "https://discord.com/api/webhooks/815096858258309121/Y1P8fo6CiIvZG6SuqDkCRU_y_R2Z6KZhpTPI6RwEHxM7v8yV3u2V_h9bDdPEIassns4z"