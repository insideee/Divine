...
GameStore.Categories = { 
  {
    ...
    name = "Premium Itens",
    rookgaard = true,
    subclasses = {"Outifits/Mounts", "Cobra Itens", "Falcon Itens", "Gnome Itens", "Various Itens"},
  },
   { 
  --Premium Time
    icons = { "Category_PremiumTime.png" },
    name = "Outifits/Mounts",   
    parent = "Premium Itens",
    rookgaard = true,
  ...
  --itens cobra
    ...
    state = GameStore.States.STATE_NONE,
         offers = {
         {
           ...
           itemtype = 35228,   
           count = 1,
           description = "<i>You see a cobra crossbow. (Range: 6, Atk +7, Hit% +6, distance fighting +2). It can only be wielded properly by paladins of level 220 or higher",
         ...
         },
         {
           ...
           itemtype = 35230,   
           count = 1,
           description = "<i>You see a cobra club. (Atk:8 physical + 44 fire, Def:29 +2, club fighting +2). It can only be wielded properly by knights of level 220 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           icons = { "Cobra_Axe.png" },
           ...
           itemtype = 35231,   
           count = 1,
           description = "<i>You see a cobra axe. (Atk:8 physical + 44 ice, Def:29 +2, axe fighting +2). It can only be wielded properly by knights of level 220 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 35233,   
           count = 1,
           description = "<i>You see a cobra axe. (Atk:52, Def:31 +2, sword fighting +3). It can only be wielded properly by knights of level 220 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 35234,   
           count = 1,
           description = "<i>You see a cobra wand.(critical hit chance +10%, critical hit damage +35%, magic level +2). It can only be wielded properly by sorcerers of level 270 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     { 
       icons = { "Cobra_Rod.png" },
           ...
           itemtype = 35235,   
           count = 1,
           description = "<i>You see a cobra rod. (life leech chance +100%, life leech amount +18%, magic level +2). It can only be wielded properly by druids of level 220 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 35232,   
           count = 1,
           description = "<i>You see a cobra hood. (Arm:9, club fighting +1, sword fighting +1, axe fighting +1, protection physical +5%). It can only be wielded properly by knights of level 270 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
       },
  },
  ...
  --itens cobra
    ...
    state = GameStore.States.STATE_NONE,
         offers = {
         {
           ...
           itemtype = 32420,   
           count = 1,
           description = "<i>You see falcon greaves (Arm:10, club fighting +3, sword fighting +3, axe fighting +3, distance fighting +3, protection physical +7%, ice +7%). It can only be wielded properly by knights and paladins of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,				
         },
         {
           ...
           itemtype = 32419,   
           count = 1,
           description = "<i>You see a falcon plate (Arm:18, shielding +4, protection physical +12%). It can only be wielded properly by knights of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 32418,   
           count = 1,
           description = "<i>You see a falcon bow (Range: 6, Atk +7, Hit% +5, distance fighting +2, protection fire +5%). It can only be wielded properly by paladins of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 32417,   
           count = 1,
           description = "<i>You see a falcon wand (magic level +3, protection fire +8%). It can only be wielded properly by sorcerers of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 32414,   
           count = 1,
           description = "<i>You see a falcon circlet (Arm:8, magic level +2, protection fire +9%). It can only be wielded properly by sorcerers and druids of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     { 
       icons = { "Falcon_Rod.png" },
           ...
           itemtype = 32416,   
           count = 1,
           description = "<i>You see a falcon rod (magic level +3, protection energy +8%). It can only be wielded properly by druids of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 32415,   
           count = 1,
           description = "<i>You see a falcon coif (Arm:10, distance fighting +2, shielding +2, protection physical +3%, fire +10%). It can only be wielded properly by knights and paladins of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 32423,   
           count = 1,
           description = "<i>You see a falcon longsword (Atk:56, Def:34, sword fighting +4, protection earth +10%). It can only be wielded properly by knights of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 32422,   
           count = 1,
           description = "<i>You see a falcon escutcheon (Def:40, protection physical +7%, fire +15%). It can only be wielded properly by knights and paladins of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
         {
           ...
           itemtype = 32424,   
           count = 1,
           description = "<i>You see a falcon battleaxe (Atk:10 physical + 47 energy, Def:33, axe fighting +4, protection energy +12%). It can only be wielded properly by knights of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
             {
           ...
           itemtype = 32425,   
           count = 1,
           description = "<i>You see a falcon mace (Atk:11 physical + 41 energy, Def:33 +3, club fighting +3, protection energy +7%). /n/n It can only be wielded properly by knights of level 300 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
       },
 },
   ...
   icons = { "Category_PremiumTime.png" },
    ...
    state = GameStore.States.STATE_NONE,
         offers = {
         {
           ...
           itemtype = 30882,   
           count = 1,
           description = "<i>You see a gnome helmet (Arm:7, magic level +2, protection physical +3%, energy +8%, ice -2%). It can only be wielded properly by sorcerers and druids of level 200 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
         {
           ...
           itemtype = 30883,   
           count = 1,
           description = "<i>You see a gnome armor (Arm:17, distance fighting +3, protection physical +4%, energy +8%, ice -2%). It can only be wielded properly by paladins of level 200 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 30884,   
           count = 1,
           description = "<i>You see a gnome legs (Arm:9, magic level +2, protection energy +7%, ice -2%). It can only be wielded properly by sorcerers and druids of level 200 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 30886,   
           count = 1,
           description = "<i>You see a gnome sword (Atk:10 physical + 42 energy, Def:29 +3, sword fighting +2, protection energy +6%). It can only be wielded properly by knights of level 250 or higher",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 30885,   
           count = 1,
           description = "<i>You see a gnome shield (Def:38, shielding +2, protection physical +6%, energy +8%, ice -2%). It can only be wielded properly by knights and paladins of level 200 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
       },
     },
    ...
    state = GameStore.States.STATE_NONE,
         offers = {
         {
           ...
           itemtype = 22424,   
           count = 1,
           description = "<i>You see an umbral master spellbook (Def:20, magic level +4, protection energy +5%, earth +5%, fire +5%, ice +5%). It can only be wielded properly by sorcerers and druids of level 250 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
         {
           icons = { "Fabulous_Legs.png" },
           name = "Fabulous Legs", 
           price = 350, 
           itemtype = 37452,   
           count = 1,
           description = "<i>You see a fabulous legs (Arm:9, club fighting +2, sword fighting +2, axe fighting +2, distance fighting +2, protection physical +4%, fire +2%). It can only be wielded properly by knights and paladins of level 225 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           ...
           itemtype = 36452,   
           count = 1,
           description = "<i> You see winged boots (Arm:2, distance fighting +1, protection earth +7%, speed +15). It can only be wielded properly by paladins of level 220 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
     {
           icons = { "Pair_Of_Nightmare_Boots.png" },
           name = "pair of nightmare boots", 
           price = 350, 
           itemtype = 37454,   
           count = 1,
           description = "<i>You see pair of nightmare boots (Arm:2, magic level +1, protection energy +6%). It can only be wielded properly by sorcerers and druids of level 140 or higher.",
           type = GameStore.OfferTypes.OFFER_TYPE_ITEM,					
         },
       },
  },   {
