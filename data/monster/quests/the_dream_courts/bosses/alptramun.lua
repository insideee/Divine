...
monster.loot = {
	...
	{name = "Purple Tendril Lantern", chance = 90},
	...
	{name = "Dream Shroud", chance = 90},
	{name = "Pair of Dreamwalkers", chance = 90},
	{name = "Soul Stone", chance = 90},
	{id = 26185, chance = 10590},
	{name = "Pomegranate", chance = 90},
	{name = "Dream Shroud", chance = 90},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -1500, maxDamage = -1500, range = 7, length = 6, spread = 3, shootEffect = CONST_ANI_POISON, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -700, maxDamage = -1600, range = 3, length = 6, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_FIREDAMAGE, minDamage = -900, maxDamage = -1600, range = 3, length = 6, spread = 3, effect = CONST_ME_HITBYFIRE, target = false},
	{name ="stone shower", interval = 2000, chance = 25, minDamage = -230, maxDamage = -450, range = 7, target = false}
}
