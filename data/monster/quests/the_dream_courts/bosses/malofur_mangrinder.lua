...
monster.loot = {
	...
	{name = "Ring of the Sky", chance = 90},
	{name = "Crunor Idol", chance = 90},
	{name = "Resizer", chance = 90},
	{name = "Shoulder Plate", chance = 90},
	{name = "Malofur's Lunchbox", chance = 90},
	{name = "Pomegranate", chance = 90}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -1500, maxDamage = -2000},
	{name = "combat", type = COMBAT_LIFEDRAIN, interval = 2000, chance = 10, length = 8, spread = 3, minDamage = -900, maxDamage = -1600, effect = CONST_ME_SMALLCLOUDS},
}
