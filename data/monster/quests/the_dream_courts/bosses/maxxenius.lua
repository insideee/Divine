...
monster.loot = {
	...
	{name = "Energized Limb", chance = 120},
	{name = "Purple Tendril Lantern", chance = 120}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -1000, maxDamage = -1000},
	{name ="energy beam", interval = 2000, chance = 15, minDamage = -900, maxDamage = -1200, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="energy wave", interval = 2000, chance = 15, minDamage = -900, maxDamage = -1200, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = false}
}
