...
monster.loot = {
	...
	{name = "ice shield", chance = 120},
	{name = "chaos mace", chance = 120},
	...
	{name = "beast's nightmare-cushion", chance = 120},
	{name = "violet gem", chance = 6470},
	{name = "magic sulphur", chance = 6470},
	{name = "purple tendril lantern", chance = 200},
	...
	{name = "turquoise tendril lantern", chance = 200},
	{name = "dark whispers", chance = 120},
	{name = "arcane staff", chance = 120},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -1500, maxDamage = -2200, radius = 10, effect = CONST_ME_MORTAREA, target = false},
