...
monster.loot = {
	...
	{name = "falcon bow", chance = 50, maxCount = 1},
	{name = "falcon circlet", chance = 50, maxCount = 1},
	{name = "falcon coif", chance = 50, maxCount = 1},
	{name = "falcon rod", chance = 50, maxCount = 1},
	{name = "falcon wand", chance = 50, maxCount = 1},
	{name = "falcon shield", chance = 50, maxCount = 1},
	{name = "falcon greaves", chance = 50, maxCount = 1},
	{name = "falcon plate", chance = 50, maxCount = 1},
}
