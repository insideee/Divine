...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_MANADRAIN, minDamage = 1500, maxDamage = -2000, range = 1, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_LIFEDRAIN, minDamage = 1500, maxDamage = -2000, range = 7, effect = CONST_ME_MAGIC_RED, target = true}
}

monster.defenses = {
	defense = 20,
	armor = 15,
	{name ="combat", interval = 1000, chance = 1, type = COMBAT_HEALING, minDamage = 0, maxDamage = 200, effect = CONST_ME_MAGIC_BLUE, target = false},
	{name ="combat", interval = 3500, chance = 30, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 200, effect = CONST_ME_MAGIC_BLUE, target = false},
