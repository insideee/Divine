...
local voices = { {text = 'Falai champs, deixa eu ver aquele double biceps!'} }
...
npcHandler:setMessage(MESSAGE_GREET, "Birrrrl, que nao vai dar oque |PLAYERNAME|!")
npcHandler:setMessage(MESSAGE_FAREWELL, "Vai lá campeão, |PLAYERNAME|.")
npcHandler:setMessage(MESSAGE_WALKAWAY, "Birrrrl.")
