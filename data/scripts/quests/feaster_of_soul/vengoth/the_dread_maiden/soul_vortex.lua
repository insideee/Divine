...
function soulVortex.onStepIn(creature, item, position, fromPosition)
	...
	creature:remove()
	if name == "Blue Soul Stealer" then
		Game.createMonster("Blue Soul Stealer", Position({x = 33709, y = 31500, z = 14}), false, true)
	elseif name == "Green Soul Stealer" then
		Game.createMonster("Green Soul Stealer", Position({x = 33709, y = 31504, z = 14}), false, true)
	elseif name == "Red Soul Stealer" then
		Game.createMonster("Red Soul Stealer", Position({x = 33716, y = 31506, z = 14}), false, true)
	end
	return true
end
